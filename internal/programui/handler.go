...
const (
	contentSecurityPolicy = "default-src 'self'; script-src 'self' 'sha256-1g52aODucP5iIOZr/bOY8JbexyHXUG7wjvDZrNoq3u0=' 'sha256-MfYP1/O9L1GkAYNpGNxI0PEPnH0Q8FzCgzgCxl2e4YQ='; style-src 'self' 'sha256-4ptMEUb9eurT1iIZ9wcZxnVMZAO/Bp8CSJ2RC2IRx5Q='; connect-src 'self'; img-src 'self' data:; object-src 'none'; base-uri 'none'; frame-ancestors 'none'"
