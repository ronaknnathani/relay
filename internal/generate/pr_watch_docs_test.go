	...
	for _, test := range []struct {
		...
		},
		{
			...
			required: []string{
				...
				"defensively treats a GraphQL `RATE_LIMITED` error as recoverable",
				"Current `gh` versions report these GraphQL responses as command failures",
