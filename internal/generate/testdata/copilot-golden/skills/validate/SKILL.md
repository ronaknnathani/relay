...
- If `ATTEMPTS >= 3`: stop. Display the verification failures from `$PROJ/verification.md` and ask the user how to proceed (use ask_user).
...
3. Use ask_user: "Implementation complete and validated. Ready to ship?"
